        ...
        <div class="container">
            ...
            <div class="row shuffle-wrapper portfolio-gallery">
                @foreach ($doctors as $doctor)
                    <div class="col-lg-3 col-md-6 mb-4 shuffle-item" data-groups="[&quot;,&quot;cat2&quot;]">
                        <div class="position-relative doctor-inner-box">
                            <div class="doctor-profile">
                                <div class="doctor-img">
                                    <img src="{{ asset($doctor->photo) }}" alt="doctor-image" class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="content mt-3">
                                <h4 class="mb-0"><a
                                        href="{{ route('Doctor.create', $doctor->id) }}">{{ $doctor->name }}</a></h4>
                ...
                <div class="col-lg-7">
                    <div class="cta-content">
                        ...
                        <h2 class="mb-5 text-lg">We are pleased to offer you the <span class="title-color">chance to have
                                the healthy</span></h2>
                        <a href="{{ route('appoinment.create') }}" class="btn btn-main-2 btn-round-full">Get appoinment<i
