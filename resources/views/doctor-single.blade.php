            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="doctor-img-block">
                        <img src="{{ asset($doctor->photo) }}" alt="" class="img-fluid w-100">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="doctor-details mt-4 mt-lg-0">
                        ...
                        <a href="{{ route('appoinment1.create', $doctor->name) }}"
                            class="btn btn-main-2 btn-round-full mt-3">Make an
                ...
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <div class="edu-block mb-5">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi doloremque harum, mollitia, soluta
                            maxime
                            porro veritatis fuga autem impedit corrupti aperiam sint, architecto, error nesciunt temporibus!
                            Vel quod,
                            dolor aliquam!</p>
                    </div>
